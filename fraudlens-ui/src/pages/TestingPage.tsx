  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-[#00D278]/10 via-[#0050FF]/5 to-[#A855F7]/10 rounded-[32px] blur-3xl" />
        <div className="glass-hero rounded-[32px] p-10 relative overflow-hidden">
          <div className="flex items-center gap-5 relative z-10">
            <motion.div
              whileHover={{ scale: 1.05, rotate: 5 }}
              className="h-16 w-16 rounded-3xl bg-gradient-to-br from-[#00D278] to-[#0050FF] flex items-center justify-center shadow-[0_0_60px_rgba(0,210,120,0.3)]"
            >
          ...
          <TabsList className="glass-card-float rounded-2xl p-2 bg-white/[0.02] border border-white/5 h-auto flex-wrap gap-2">
            {[
              ...
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="data-[state=active]:bg-[#00D278]/10 data-[state=active]:border-[#00D278]/20 data-[state=active]:text-[#00D278] border border-transparent rounded-xl px-6 py-3 text-white/30 hover:text-white/50 transition-all"
              >
            ...
            <div className="glass-card-float rounded-[28px] p-8 border border-white/5">
              <div className="flex items-center gap-4 mb-6">
                <div className="h-10 w-10 rounded-xl bg-[#00D278]/10 border border-[#00D278]/20 flex items-center justify-center">
                  <Shield className="h-5 w-5 text-[#00D278]" />
                </div>
                <div>
          ...
          <TabsContent value="performance" className="space-y-6">
            <div className="glass-card-float rounded-[28px] p-8 border border-white/5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  { label: "Response Time", value: "24ms", color: "#00D278" },
                  { label: "Throughput", value: "1.2k/s", color: "#0050FF" },
                  { label: "Error Rate", value: "0.02%", color: "#A855F7" },
                ].map((metric, i) => (
                  <motion.div
                    key={metric.label}
